...
date: today
date-format: long
abstract: "School shootings in the United States vary in fatality, ... This analysis uses logistic regression on data from The Washington Post School Shootings Database to model the probability that a shooting results in at least one death. Findings indicate that incidents involving targeted or indiscriminate intent, no non-shooter injuries, and shooters connected to the school community are more likely to be fatal. These results highlight the need for proactive safety measures focused on behavioral monitoring, threat assessment, and emergency preparedness."
format: 
  pdf:
    include-in-header:
        text: |
