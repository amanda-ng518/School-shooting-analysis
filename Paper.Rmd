...
```{r fig7, echo = FALSE,fig.width=8, fig.height=4, fig.align='center', fig.cap= 'Performance Metrics vs. Threshold for the logistic regression model. Each colored line represents the trend of the metric value as the threshold increases from 0 to 1. Red line represents missclassification rate, green line represents sentisivity and blue line represents specificity. '}
...
```{r fig8, echo=FALSE,fig.width=8, fig.height=3.25, fig.align='center', fig.cap= 'Distribution of Shooter Age by Killing Occurrence. Bars represent the distribution of shooter ages for incidents that did and did not result in at least one killing, with overlapping areas shaded to allow comparison. The red bars correspond to fatal shootings, while the blue bars correspond to non-fatal shootings.'}
...
```{r fig9, echo=FALSE,fig.width=8, fig.height=3.25, fig.align='center', fig.cap= 'Distribution of Proportion of Non-white student by Killing Occurrence. Bars represent the distribution of proportion of non-white students for incidents that did and did not result in at least one killing, with overlapping areas shaded to allow comparison. The red bars correspond to fatal shootings, while the blue bars correspond to non-fatal shootings.'}
...
```{r fig10, echo=FALSE,fig.width=8, fig.height=3.25, fig.align='center', fig.cap= 'Distribution of Proportion of Students Eligible for Subsidized Lunch by Killing Occurrence. Bars represent the distribution of proportion of students eligible for subsidized for incidents that did and did not result in at least one killing, with overlapping areas shaded to allow comparison. The red bars correspond to fatal shootings, while the blue bars correspond to non-fatal shootings.'}
